...
//
//
//    public TableOfContentsAdapter(Context context, List<TocParentModel> parent) {
//        this.parentList = parent;
//        this.mContext = context;
//        inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//        bookName = parentList.get(0).getFileName();
//        title = parentList.get(0).getFileTitle();
//        fileId = parentList.get(0).getFileId();
//    }
//
//    @Override
...
//        vhp.tv_parent.setText(parentList.get(groupPosition).getName());
...
//        childrenModel = new TocChildrenModel();
//        childrenModel = parentList.get(groupPosition).getTocChildrenAray().get(childPosition);
//        String ch_name = childrenModel.getName();
//        Log.d("", "");
//
...
//        } else {
//            vhc.tv_child.setText(parentList.get(groupPosition).getTocChildrenAray().get(childPosition).getName());
//
...
//
//                    //String bookName = parentList.get(groupPosition).getTableOfContentsFileModel().getName();
//                    int pageNo = parentList.get(groupPosition).getTocChildrenAray().get(childPosition).getPageNo();
//
//                    Intent i = new Intent(mContext, BookInsideActivity.class);
//                    i.putExtra("book_name", bookName);
//                    i.putExtra("book_title", title);
...
//                public void onClick(View v) {
//
////                    if(parentList.get(groupPosition).getChildrenArray().get(childPosition).isChecked()){
