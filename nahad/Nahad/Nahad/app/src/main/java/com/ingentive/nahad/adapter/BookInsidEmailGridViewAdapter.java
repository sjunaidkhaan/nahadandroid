 ...
 * Created by PC on 03-06-2016.
 */
public class BookInsidEmailGridViewAdapter extends BaseAdapter {
    ...
    public BookInsidEmailGridViewAdapter(Context context, int layoutResourceId, List<GridViewModel> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        vh. button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new Delete().from(SendEmailModel.class).where("page_no=?", data.get(position).getPageNo()).execute();
