 ...
 * Created by PC on 03-06-2016.
 */
public class TocEmailGridViewAdapter extends BaseAdapter {
    ...
    public TocEmailGridViewAdapter(Context context, int layoutResourceId, List<GridViewModel> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        vh. button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int pageno=data.get(position).getPageNo();
                new Delete().from(EmailSelectedTemp.class).where("page_no=?", data.get(position).getPageNo()).execute();
